...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-emerald-500/30">
      ...
      <main className="max-w-5xl mx-auto px-8 py-24 flex flex-col items-center text-center">
        ...
        <div className="flex items-center gap-4">
          <Link href="/playground" className="flex items-center gap-2 bg-emerald-500 text-black px-6 py-3 rounded-full font-semibold hover:bg-emerald-400 transition-colors">
            Try the Playground <ArrowRight className="w-4 h-4" />
          </Link>
          <Link href="/docs" className="flex items-center gap-2 bg-white/5 text-white px-6 py-3 rounded-full font-semibold hover:bg-white/10 transition-colors border border-white/10">
            View API Docs
          </Link>
        </div>
      </main>
